...
function get_profile($user_id)
{
    ...
    $sql  = "SELECT user_name, birthday, sex, question, answer, rank_points, pay_points,user_money, user_rank,".
             " msn, qq, office_phone, home_phone, mobile_phone, passwd_question, passwd_answer,real_name,idtype,customerid ".
    ...
    $info['idtype'] = $infos['idtype'];
    $info['customerid'] = $infos['customerid'];
    return $info;
}
