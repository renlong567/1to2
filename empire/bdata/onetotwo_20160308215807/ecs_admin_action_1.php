...
E_D("replace into `ecs_admin_action` values('210','0','05_custom','');");
E_D("replace into `ecs_admin_action` values('211','210','cus_01_list','');");
E_D("replace into `ecs_admin_action` values('213','210','cus_03_hg_country','');");
E_D("replace into `ecs_admin_action` values('214','210','cus_04_jy_country','');");
E_D("replace into `ecs_admin_action` values('215','210','cus_05_hg_unit','');");
E_D("replace into `ecs_admin_action` values('216','210','cus_05_jy_unit','');");
E_D("replace into `ecs_admin_action` values('217','210','cus_06_hg_curr','');");
E_D("replace into `ecs_admin_action` values('218','210','cus_06_jy_curr','');");
