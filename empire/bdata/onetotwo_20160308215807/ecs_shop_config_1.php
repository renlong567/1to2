...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','一比二商城（www.onetotwo.cc）','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','一比二商城（www.onetotwo.cc）','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','一比二商城（www.onetotwo.cc）','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','一比二商城（www.onetotwo.cc）','1');");
...
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','东明路260号正弘旗（郑州海关东侧）1号楼4单元902室','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','7600687','1');");
...
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','0371-63906611','1');");
...
E_D("replace into `ecs_shop_config` values('121','1','shop_notice','textarea','','','欢迎光临一比二商城！','1');");
...
E_D("replace into `ecs_shop_config` values('202','2','icp_number','text','','','©onetotwo.cc 豫ICP备15036577号','1');");
...
E_D("replace into `ecs_shop_config` values('213','2','sn_prefix','text','','','one','1');");
...
E_D("replace into `ecs_shop_config` values('312','3','top_number','text','','','12','1');");
...
E_D("replace into `ecs_shop_config` values('319','3','page_size','text','','','12','1');");
...
E_D("replace into `ecs_shop_config` values('330','3','search_keywords','text','','','身体护理,进口果蔬','0');");
...
E_D("replace into `ecs_shop_config` values('334','3','article_page_size','text','','','12','1');");
...
E_D("replace into `ecs_shop_config` values('902','9','wap_logo','file','','../images/','../images/wap_logo.gif','1');");
E_D("replace into `ecs_shop_config` values('903','2','message_check','select','1,0','','1','1');");
E_D("replace into `ecs_shop_config` values('10','0','cus','group','','','','1');");
E_D("replace into `ecs_shop_config` values('1000','10','cus_cbecode','text','','','D461200044','1');");
E_D("replace into `ecs_shop_config` values('1001','10','cus_cbename','text','','','一比二商城','1');");
E_D("replace into `ecs_shop_config` values('1002','10','cus_ecpcode','text','','','W461200040','1');");
E_D("replace into `ecs_shop_config` values('1003','10','cus_ecpname','text','','','一比二平台','1');");
E_D("replace into `ecs_shop_config` values('1004','10','cus_taxedenterprise','text','','','H451210','1');");
E_D("replace into `ecs_shop_config` values('1005','10','cus_cbecodeinsp','text','','','4100102324','2');");
E_D("replace into `ecs_shop_config` values('1006','10','cus_ecpcodeinsp','text','','','4100102324','2');");
E_D("replace into `ecs_shop_config` values('1007','10','cus_trepcodeinsp','text','','','4100102324','2');");
E_D("replace into `ecs_shop_config` values('1010','10','cus_declcode','text','','','4101983536','1');");
E_D("replace into `ecs_shop_config` values('1011','10','cus_declname','text','','','一比二报关','1');");
E_D("replace into `ecs_shop_config` values('1012','10','cus_payenterprisecode','text','','','P461200031','1');");
E_D("replace into `ecs_shop_config` values('1013','10','cus_payenterprisename','text','','','一比二支付','1');");
E_D("replace into `ecs_shop_config` values('1014','10','cus_paycode','text','','','4100102324','2');");
E_D("replace into `ecs_shop_config` values('1015','10','cus_lmsno','text','','','1015','1');");
E_D("replace into `ecs_shop_config` values('1016','10','cus_manualno','text','','','H20101015','1');");
E_D("replace into `ecs_shop_config` values('1017','10','cus_deliveryenterprisecode','text','','','L461200029','1');");
E_D("replace into `ecs_shop_config` values('1018','10','cus_deliveryenterprisename','text','','','一比二物流','1');");
E_D("replace into `ecs_shop_config` values('1019','10','cus_senderuseraddress','text','','','北京市东城区南环1号','1');");
E_D("replace into `ecs_shop_config` values('1020','10','cus_senderusercountry','text','','','142','1');");
E_D("replace into `ecs_shop_config` values('1021','10','cus_senderusername','text','','','一比二商城','1');");
E_D("replace into `ecs_shop_config` values('1022','10','cus_senderusertelephone','text','','','13321673916','1');");
E_D("replace into `ecs_shop_config` values('1023','10','cus_sendusercountryinsp','text','','','156','1');");
