...
E_D("replace into `ecs_shop_config` values('1000','10','cus_lmsno','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1001','10','cus_manualno','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1002','10','cus_ecpcode','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1003','10','cus_ecpname','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1004','10','cus_taxedenterprise','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1005','10','cus_cbecodeinsp','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1006','10','cus_ecpcodeinsp','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1007','10','cus_trepcodeinsp','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1010','10','cus_declcode','text','','','','1');");
E_D("replace into `ecs_shop_config` values('1011','10','cus_declname','text','','','','1');");
