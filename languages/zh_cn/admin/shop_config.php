...
$_LANG['cfg_name']['cus'] = '三关设置';
$_LANG['cfg_name']['cus_lmsno'] = 'S册账号';
$_LANG['cfg_name']['cus_manualno'] = '关联H2010账册号';
$_LANG['cfg_name']['cus_cbecode'] = '电商编号(海关备案)';
$_LANG['cfg_name']['cus_cbename'] = '电商名称(海关备案)';
$_LANG['cfg_name']['cus_ecpcode'] = '电商平台编号(海关备案)';
$_LANG['cfg_name']['cus_ecpname'] = '电商平台名称(海关备案)';
...
$_LANG['cfg_name']['cus_senderusername'] = '发货人名称(海关)';
$_LANG['cfg_name']['cus_senderusertelephone'] = '发货人电话(海关)';

$_LANG['cfg_name']['cus_collusercountryinsp'] = '发货人所在国(CIQ)';
$_LANG['cfg_name']['cus_sendusercountryinsp'] = '收货人所在国(CIQ)';
$_LANG['cfg_name']['cus_tradecompany'] = '贸易国别(CIQ)';
$_LANG['cfg_name']['cus_totalfeeunit'] = '默认币制(CIQ)';
$_LANG['cfg_name']['cus_cbecodeinsp'] = '电商编号(CIQ)';
$_LANG['cfg_name']['cus_ecpcodeinsp'] = '电商平台编号(CIQ)';
$_LANG['cfg_name']['cus_trepcodeinsp'] = '物流企业编号(CIQ)';
$_LANG['cfg_name']['cus_declcode'] = '报关企业编码(海关备案)';
$_LANG['cfg_name']['cus_declname'] = '报关企业名称(海关备案)';
$_LANG['cfg_name']['cus_payenterprisecode'] = '支付企业代码(海关备案)';
$_LANG['cfg_name']['cus_payenterprisename'] = '支付企业名称(海关备案)';
$_LANG['cfg_name']['cus_paycode'] = '支付企业编号(CIQ)';
$_LANG['cfg_name']['cus_depositorguarantee'] = '保金保函类型（进口必填）';
$_LANG['cfg_name']['cus_guaranteeno'] = '担保编号';
