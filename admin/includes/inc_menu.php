...
$modules['05_custom']['cus_01_list']                     = 'custom_list.php?act=list';

$modules['05_custom']['cus_03_hg_country']                  = 'cus_hg_country.php';
$modules['05_custom']['cus_04_jy_country']                  = 'cus_jy_country.php';
$modules['05_custom']['cus_05_hg_unit']                  = 'cus_hg_unit.php';
$modules['05_custom']['cus_05_jy_unit']                  = 'cus_jy_unit.php';
$modules['05_custom']['cus_06_hg_curr']                  = 'cus_hg_curr.php';
$modules['05_custom']['cus_06_jy_curr']                  = 'cus_jy_curr.php';
