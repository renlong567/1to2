...
elseif ($_REQUEST['step'] == 'checkout')
{
	...
	$smarty->assign('cus_info', array('real_name'=>$user_info['real_name'],'idtype'=>$user_info['idtype'],'customerid'=>$user_info['customerid']));
    /* 如果使用余额，取得用户余额 */
...
elseif ($_REQUEST['step'] == 'done')
{
    ...
    $_POST['real_name'] = isset($_POST['real_name']) ? compile_str($_POST['real_name']) : '';

    $_POST['idtype'] = isset($_POST['idtype']) ? compile_str($_POST['idtype']) : '';

    $_POST['customerid'] = isset($_POST['customerid']) ? compile_str($_POST['customerid']) : '';
